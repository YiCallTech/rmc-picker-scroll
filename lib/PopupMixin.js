...
function PopupMixin(getModal, platformProps) {
    ...
    return _a = function (_React$Component) {
        ...
        function _a(props) {
            ...
            _this.getContent = function () {
                if (_this.props.picker) {
                    ...
                    return React.cloneElement(_this.props.picker, (_React$cloneElement = {}, (0, _defineProperty3['default'])(_React$cloneElement, _this.props.pickerValueProp, pickerValue), (0, _defineProperty3['default'])(_React$cloneElement, _this.props.pickerValueChangeProp, _this.onPickerChange), (0, _defineProperty3['default'])(_React$cloneElement, 'ref', _this.saveRef), _React$cloneElement));
                } else {
        ...
        return _a;
    }(React.Component), _a.defaultProps = (0, _extends3['default'])({
